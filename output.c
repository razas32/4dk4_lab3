...
#include "main.h"
#include "output.h"
#include <math.h>  // Add this line to include the math.h header
...
void output_results(Simulation_Run_Ptr this_simulation_run, 
                    double simulated_blocking_prob,
                    double theoretical_blocking_prob)
{
  ...
  printf("Blocking probability (simulation) = %.5f\n", simulated_blocking_prob);
  printf("Blocking probability (Erlang B) = %.5f\n", theoretical_blocking_prob);
  printf("Difference = %.5f\n", fabs(simulated_blocking_prob - theoretical_blocking_prob));
